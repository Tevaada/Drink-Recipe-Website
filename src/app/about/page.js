        ...
        <div className={styles.page}>
            <section className={styles.introduction}>
                <div className={styles.visual}>
                    <div className={styles.visualMark}>LM</div>
                    <p>Drink with intention</p>
                </div>

                <div className={styles.content}>
                    <span className={styles.eyebrow}>The vision</span>
                    <h1>Better drinks begin with better information</h1>

                    <p>
                        This project brings recipes, ingredients, and
                        preparation guidance into one approachable collection.
                        It helps people discover drinks for different tastes,
                        occasions, and routines.
                    </p>

                    <p>
                        Our goal is not to make wellness complicated. We focus
                        on clear recipes, useful details, and an experience that
